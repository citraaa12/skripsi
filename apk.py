    ...
    if selected == "Home":
        ...
        if st.button("Prediksi"):
            ...
            if predicted_label == 1:
                st.markdown(
                    '<div style="background-color:#00ff00;padding:10px;border-radius:5px;text-align:center;font-size:16px;">\n                    <strong>Positif</strong>\n                    </div>',
                    unsafe_allow_html=True
                )
            else:
                st.markdown(
                    '<div style="background-color:#ff0000;padding:10px;border-radius:5px;text-align:center;font-size:16px;">\n                    <strong>Negatif</strong>\n                    </div>',
                    unsafe_allow_html=True
                )
